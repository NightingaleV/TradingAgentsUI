...
Engage actively by analyzing both sides critically, addressing weaknesses in the aggressive and conservative arguments to advocate for a more balanced approach. Challenge each of their points to illustrate why a moderate risk strategy might offer the best of both worlds, providing growth potential while safeguarding against extreme volatility. Focus on debating rather than simply presenting data, aiming to show that a balanced view can lead to the most reliable outcomes. Output conversationally as if you are speaking without any special formatting.""" + get_language_instruction()
        ...
        response_content = invoke_agent_text(llm, prompt, "Neutral Analyst")
        if response_content is None:
            skipped_turn = (
                "[Neutral Analyst skipped this turn because the model provider "
            ...
            return {
                "risk_debate_state": {
                    ...
                    "current_neutral_response": skipped_turn,
                    "count": risk_debate_state["count"] + 1,
                },
                "pipeline_warnings": [content_filter_warning("Neutral Analyst")],
            }
